...
export default function ClientBill() {
    ...
    const switchBadge = (status) => {
        switch (status) {
            ...
            case "UNPAID":
                return <Badge variant="secondary" className="whitespace-nowrap">Chưa thanh toán</Badge>;
            case "EXPIRED":
                                    ...
                                    {bills.map((bills) => (
                                        <TableBody key={bills.code}>
                                            <TableRow>
                                                ...
                                                <TableCell>{switchBadge(bills.status)}</TableCell>
                                            </TableRow>
                                        </TableBody>
                                    ))}
                                </Table>
                                    ...
                                    {billmonths.map((billmonth) => (
                                        <TableBody key={billmonth.code}>
                                            <TableRow>
                                                ...
                                                <TableCell>{switchBadge(billmonth.status)}</TableCell>
                                            </TableRow>
                                        </TableBody>
                                    ))}
                                </Table>
